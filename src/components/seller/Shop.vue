  ...
  <div style="width: 1000px; margin: 0px auto;">
    <div style="width: 1000px; min-width: 1000px; margin: 0px auto;">
      ...
      <div style=" width: 1000px;height: 19px; padding: 6px 0px; border-bottom: 2px solid #5884ff">
        ...
        <p>&nbsp;&nbsp;{{info.shopName }}</p>
        <!--<p style="float:left; text-align:center; margin-left:10px;font-size: 13px; font-weight: 500; color: #000000; width: 70px; height: 19px; border-radius: 3px; background:#2a56d7;">SHOP</p>-->
      </div>
        ...
        <li v-bind:key="data" v-for="data in datas" style="border-color:black;border-width: 1px;" >
          ...
          <div style="width: 840px;height: 150px;margin: 0px;float: right;">
            <div style="width: 680px;height: 140px;margin: 5px auto;float: left" v-on:click="goGood(data)">
              <p style="width: 250px;height: 55px; margin: 10px 5px 5px;float: left;text-align: center; vertical-align: center; line-height: 100px; font-weight: 700; font-size: 12px; color: black;">{{ data.pName }}</p>
              <p style="width: 150px;height: 140px; margin: 10px 30px 5px;text-align: center;float: left; line-height: 110px;font-weight: 900; font-size: 12px; color: #d71216;">💰¥{{ data.price }}</p>
              <p style="height: 140px; margin: 10px 30px 5px;text-align: center;float: left; line-height: 110px;font-weight: 900; font-size: 12px; color: #d7116a;">Count:{{ data.num }}</p>
            </div>
