<template>
  <div style="width: 1000px; margin: 0px auto;">
    <div style="width: 1000px; min-width: 1000px; margin: 0px auto;">
      ...
      <div style=" width: 1000px;height: 19px; padding: 6px 0px; border-bottom: 2px solid #094fa4">
      ...
      <div style="height: 120px; width: 1000px;">
        ...
        <p src="../../assets/logo.png"  style="float:left; width: 880px; height: 120px; font-size: 30px; line-height: 120px; text-align: center; color: rgb(9,79,164);">{{ info.shopName }}</p>
      </div>
    </div>
