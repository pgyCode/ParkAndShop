  ...
  <div style="width: 1000px; margin: 0px auto;">
     <div style="width: 1000px; min-width: 1000px; margin: 0px auto;">
       ...
       <div style=" width: 1000px;height: 19px; padding: 6px 0px; border-bottom: 2px solid #5884ff">
         ...
         <p >&nbsp;&nbsp; {{ info.shopName }}</p>
         <button style="float: right; width: 178px; height: 38px; margin-left: 5px; border: none; background: blue; color: #fff; font-weight: 400; font-size: 16px" v-on:click="addFavouriteShop()">Favourite</button>
       </div>
